...
export const messages = {
  titulo: {
    ...
    tooShort: "El titulo tiene que ser de al menos 3 caracteres",
  },
  categoria: {
  ...
  descripcion: {
    ...
    tooShort: "La descripcion tiene que ser de al menos 3 caracteres",
    tooLong: "La descripcion alcanzó su longitud maxima",
  },
};
...
const GlobalContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/mikelzen/aluraflix-database/categorias"
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/mikaelzen/aluraflix-database/videos"
    )
      .then((res) => res.json())
  ...
  const deleteVideo = (id) => {
    fetch(
      `https://my-json-server.typicode.com/mikaelzen/aluraflix-database/videos/${id}`,
      { method: "DELETE" }
    )
      .then((res) => {
        if (!res.ok) {
